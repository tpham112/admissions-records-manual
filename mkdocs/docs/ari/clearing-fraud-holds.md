...
3. Locate the fraud hold on the student's record and enter yesterday's date as the end date.
    ...
    ![Locate the fraud hold and enter yesterday's date as the end date](../images/clearing-fraud-holds-1.png)

4. Detail into the hold.

    ![Detail into the hold](../images/clearing-fraud-holds-2.png)

5. Click Timestamp and enter comments.

    ![Click Timestamp and enter comments](../images/clearing-fraud-holds-3.png)
