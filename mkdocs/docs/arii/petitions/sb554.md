...
| Scenario | Procedure |
|----------|-----------|
| Student has any previous applications | Insert a new line and add `SB554`; set the date to one day before the start of the requested term |
| Student has not taken any courses with us yet | Update the Student Type from `RGLR` to `SB554` |
