...
5. Register the Student
    ...
    - If the course is full: **do not register** — waitlist the student instead and notify them of their waitlist status.

        ![Quote from CEC](../../images/sb554-2.png)

## Additional Notes

### Pending SB554 2.0 Forms

The regular SB554 form may be processed while the SB554 2.0 Dynamic Form is still pending, provided the following signature requirements are met:

- **CEC Counselor Signature** is present on the SB554 2.0 form.
- **Dual Enrollment Specialist Signature** is present on the SB554 2.0 form.

**Next Action:** Once both signatures are verified, process the regular SB554 form and update the student's SB554 status in the system.

![Quote Reference](../../images/sb554-1.png)